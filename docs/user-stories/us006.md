...
- [ ] Building types include:
  ...
  - Turrets: auto‑target enemies in range, require ammunition
...
- [ ] Buildings can be upgraded to more advanced versions (e.g., flame turrets, electric fences) using scrap during the map; upgrades are temporary and lost at map end
