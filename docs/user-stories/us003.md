...
- [ ] Players purchase weapons, ammo, buildings, and skill upgrades using scrap earned during the map
...
- [ ] Map ends when all waves are completed or all players are dead
...
- [ ] Implement in‑map economy (scrap earning, shop)
